...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="<%=application.getContextPath()%>/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">风险追踪系统</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script src="<%=application.getContextPath()%>/vendor/raphael/raphael.min.js"></script>
    <script src="<%=application.getContextPath()%>/vendor/morrisjs/morris.min.js"></script>
    <script src="<%=application.getContextPath()%>/data/morris-data.js"></script>
